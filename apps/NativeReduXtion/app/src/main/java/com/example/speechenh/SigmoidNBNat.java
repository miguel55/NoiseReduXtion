/*  Copyright 2015 Miguel Molina
    ...
    SigmoidNBNat is part of native code NativeReduXtion app.
 ...
 */
public abstract class SigmoidNBNat {
    public static native short[] SigmoidNB(short x1[], short x2[], boolean noise);
}
