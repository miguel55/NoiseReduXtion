/*  Copyright 2015 Miguel Molina
    ...
    FilteringFB is part of the package speech.frame of library NoiseReduXtion.
 ...
 * @author Miguel
 */
public abstract class FilteringFB extends NoiseReductionFB{
    ...
    FilteringFB(int Freq, int Lframe, int Ltransf) 
    ...
    double meanCorr (double[] v1, double[] v2, int end){
        double suma=0.0;
        for (int i=0; i<end; i++){
            suma=suma+v1[i]*v2[i];
        }
